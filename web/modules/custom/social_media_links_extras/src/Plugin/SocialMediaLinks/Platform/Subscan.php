...
/**
 * Provides 'subscan' platform.
 *
 * @Platform(
 *   id = "info-circle",
 *   name = @Translation("Subscan"),
 * )
 */
class Subscan extends PlatformBase {
  ...
  public static function validateValue(array &$element, FormStateInterface $form_state, array $form) {
    if (!empty($element['#value'])) {
      ...
      if (!UrlHelper::isValid($new_value, TRUE)) {
        $form_state->setError($element, t('The subscan website must be a valid URL'));
      }
    }
  }
